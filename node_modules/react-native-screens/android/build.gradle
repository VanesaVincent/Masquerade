...
// spotless is only accessible within react-native-assets_screens repo
...
dependencies {
    ...
    constraints {
        implementation("androidx.lifecycle:lifecycle-viewmodel-ktx:2.5.1") {
            because("on older React Native versions this dependency conflicts with react-native-assets_screens")
        }
    }
}
